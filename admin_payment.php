...
<head>
    <title>Approve Payment Page</title>
...
<body>
    ...
    <div class="sidebar">
        ...
        <div class="sidebar-menu">
            <ul>
                <li><a href="#"><span class="fa-solid fa-house"></span>
                ...
                <li><a href="admin_payment.php" class="active"><span class="fa-solid fa-credit-card"></span>
                        <span>Payment</span></a>
                </li>
